...
import { GeneratedRoundSchema, validateGeneratedRound, type GeneratedRound } from '@/lib/gemini/generated-round-zod-schema'
...
export function ImportJsonManualTab({ onValidated }: Props) {
  ...
  function handleValidate() {
    ...
    try {
      ...
      if (extra.length > 0) { setErrors(extra); return }
      setValid(true)
  ...
  return (
    <div className="flex flex-col gap-3">
      <textarea
        ...
        value={text}
        onChange={(e) => { setText(e.target.value); setValid(false); setErrors([]) }}
      />
